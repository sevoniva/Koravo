...
- Use React 19, antd 6, Umi Max 4, `@ant-design/pro-components`, utoopack, Tailwind CSS v4, `antd-style`, React Query, and Biome.
...
- Do not preserve template demo pages or demo copy. Do not add AI-sounding explanatory text.
